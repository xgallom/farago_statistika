file = fopen(strcat(pdir, '/data/csv/vs_right/vs_aorta.csv'), 'w');

fprintf(file, 'Lava voci aorte\tPrava voci aorte\tPearson\tP-Hodnota\tDolny limit\tHorny limit\tRegresia sklon\tRegresia posun\n');
